...
var _is_first_frame: bool = true # ADDED: Flag for initial position snap.
...
func _ready() -> void:
	...
	# We no longer set global_position here; it will be handled on the first physics frame.
...
func _physics_process(delta: float) -> void:
	...
	# ADDED: On the very first frame, snap position directly and skip all other logic.
	if _is_first_frame:
